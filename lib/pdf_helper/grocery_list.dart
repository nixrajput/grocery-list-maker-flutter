...
class GroceryListPdf {
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat) async {
    ...
    ByteData? _logo = await rootBundle.load('assets/logo.png');
    ByteData? _brand = await rootBundle.load('assets/brand.png');
    final _logoImage = pw.MemoryImage(_logo.buffer.asUint8List());
    final _brandImage = pw.MemoryImage(_brand.buffer.asUint8List());
  ...
  pw.Widget _contentTable(pw.Context context) {
    ...
    return pw.Table.fromTextArray(
      ...
      columnWidths: {
        0: const pw.FixedColumnWidth(32.0),
